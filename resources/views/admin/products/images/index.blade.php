...
@section('title', 'Imagenes de productos - Nombre tienda')
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            ...
                            Eliminar imagen
                                ...
                                @if ($image->featured)
                                <button type="button" class="btn btn-info btn-fab btn-fab-mini btn-round" rel="tooltip" title="Imagen destacada de {{ $product->name }} ">
